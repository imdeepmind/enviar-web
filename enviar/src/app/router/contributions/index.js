        ...
        return(
            <div>
                <div id="contributors" className="w-100 mh-100v text-left p-3 d-flex align-items-start justify-content-center flex-column text-light">
                    ...
                    <button style={{marginTop:"3px"}} onClick={this.props.history.goBack} className="border-0 text-white bg-transparent pl-4 pt-3 no-focus"><i className="fas fa-chevron-circle-left"></i></button>
                </div>
