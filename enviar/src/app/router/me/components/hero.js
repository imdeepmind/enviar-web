    ...
    render(){
        ...
        return(
            <div className="bg-primary w-100">
                <button onClick={() => this.props.history.goBack()} className="border-0 text-white bg-transparent p-2 pt-4  pl-md-4"><i style={{fontSize:"1.2rem"}} className="fas fa-chevron-circle-left"></i></button>
