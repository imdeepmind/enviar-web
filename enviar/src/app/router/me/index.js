                        ...
                        <Fragment>
                            ...
                            <Container>
                                <div className="d-flex justify-content-between align-items-center" style={tabStyle}>
                                    ...
                                    <Button className={classnames({ 'no-focus border-bottom border-primary': this.state.activeTab === '4' })} onClick={() => { this.toggle('4'); }}>
                                        <i className="fas fa-user-slash"></i>
                                        <span className="d-none d-md-inline ml-md-1">Blocked Users</span>
                                    </Button>
                                </div>
